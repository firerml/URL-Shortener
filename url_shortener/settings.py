...
SECRET_KEY = os.environ.get('URL_SHORTENER_DJANGO_SECRET_KEY', '%b-mz2@u8rh%cifyd1z#!-yre%906!1f+%-y0$tyf18*rsxa-$')
...
DATABASES = {
    'default': dj_database_url.config(default='postgres://url_shortener:@localhost:5432/url_shortener'),
}
